...
/**
 * Class tasksNotificationsSenderOneAction5Test
 */
class tasksNotificationsSenderOneAction5Test extends tasksNotificationsSenderOneActionTest
{
    /**
     * @var waContact
     */
    ...
    public function setUp()
    {
        ...
        // set projects, but subscribe only to 'assign' action
    ...
    public function testMethodGetContactIdsNeedSentTo()
    {
        ...
        $this->assertFalse(in_array($this->subscribed_contact->getId(), $contact_ids));
    }
    ...
    public function testMethodPrepareSendMap()
    {
        ...
        $this->assertFalse(in_array($this->subscribed_contact->getId(), $send_map['comment']));
    }
}
