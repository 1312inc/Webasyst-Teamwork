...
class tasksViewHelper extends waAppViewHelper
{
    ...
    public static function getPremiumPricing()
    {
        ...
        if (wa()->getLocale() == 'ru_RU')
        {
            ...
            elseif (date('Ymd')<='20250731') $pricing = array( 'compare_price' => '11 999', 'price' => '7 999 <span class="ruble">₽</span>', 'special' => '&minus;33% до 31.07', 'special_short' => '&minus;33% до 31.07', 'special_color' => 'green' );
        }
        else
        {
            ...
            elseif (date('Ymd')<='20250731') $pricing = array( 'compare_price' => '$199', 'price' => '$129', 'special' => '&minus;35%', 'special_short' => '&minus;35% / 07.31', 'special_color' => 'green' );
        }
