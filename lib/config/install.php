...
');
    ...
    try {
        ...
        $data = array_map(function ($_dr) {
            ...
            ['client', 'Заказчик', '777', 0, 1, 1, 1, 1, 1, 1],
            ['assistant', 'Соисполнитель', '777', 1, 1, 1, 1, 1, 1, 1],
            ['decision_maker', 'ЛПР', '777', 2, 1, 1, 1, 1, 1, 1],
            ['supervisor', 'Супервайзер', '777', 3, 1, 1, 1, 1, 1, 1]
        ]);
