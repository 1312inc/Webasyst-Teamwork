...
class tasksStatusesUpdateMethod extends tasksApiAbstractMethod
{
    ...
    public function run(): tasksApiResponseInterface
    {
        ...
        $request = new tasksApiStatusUpdateRequest(
        ...
        return new tasksApiStatusResponse((new tasksApiStatusUpdateHandler())->update($request));
    }
}
