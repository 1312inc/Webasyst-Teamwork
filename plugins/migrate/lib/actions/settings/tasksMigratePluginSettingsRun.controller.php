...
/**
 * Class tasksMigratePluginSettingsRunController
 * @property tasksMigrateTransport[string] $data['transport']
 */
class tasksMigratePluginSettingsRunController extends waLongActionController
{
    /**
     * @var tasksMigrateTransport
     */
    private $transport;
    ...
    protected function init()
    {
        try {
            ...
            $this->data['transport'] = tasksMigrateTransport::getTransport($transport, $options, $this->processId);
