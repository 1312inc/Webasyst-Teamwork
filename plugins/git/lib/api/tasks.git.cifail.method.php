...
/*
 {
    "GITLAB_USER_NAME": "Di Elshin",
    "GITLAB_USER_EMAIL": "dmitry.elshin@webasyst.net",
...
class tasksGitCifailMethod extends waAPIMethod
{
    ...
    {
        $users = array(
            'ilya.leonov@webasyst.ru'        => 'debosh978',
            'eugeny.poteryanov@webasyst.com' => 'eugenysp',
            'vofka@webasyst.com'             => 'vofkatuporshin',
            'alexey.polt@webasyst.ru'        => 'alex450r',
            'golubevmark@gmail.com'          => 'golubevmark',
            'sergey.belikov@webasyst.net'    => 'makhmoode',
            'mike.ushenin@webasyst.ru'       => 'thebeaver',
            'leonid.vakulenko@webasyst.net'  => 'leonyx',
            'vladislav.gorlov@webasyst.net'  => 'redisko',
            'dmitry.pavlov@webasyst.net'     => 'mitrickx',
            'dmitry.elshin@webasyst.net'     => 'elshin',
            'onemikser@gmail.com'            => 'miksser',
        );
