...
var TasksReleasesPluginTaskEdit = ( function($) { "use strict";
    ...
    TasksReleasesPluginTaskEdit = function(options) {
        var that = this;
    ...
    TasksReleasesPluginTaskEdit.prototype.init = function () {
        var that = this;
    ...
    TasksReleasesPluginTaskEdit.prototype.initMoreOptionsLink = function () {
        var that = this,
    ...
    TasksReleasesPluginTaskEdit.prototype.setReleasesType = function () {
        var that = this,
    ...
    TasksReleasesPluginTaskEdit.prototype.initValidateTaskType = function () {
        var that = this,
            $wrapper = that.$wrapper,
            $link = that.$link,
            $task = $wrapper.closest('.t-task-page-wrapper'),
    ...
    TasksReleasesPluginTaskEdit.prototype.initProjectSelector = function () {
        var that = this,
            $editor = that.$editor,
    ...
    TasksReleasesPluginTaskEdit.prototype.updateMilestoneSelector = function (milestone_id) {
        var that = this,
            $editor = that.$editor,
    ...
    TasksReleasesPluginTaskEdit.prototype.initMilestoneSelector = function () {
        var that = this,
            $editor = that.$editor,
            $selector = $editor.find('.t-milestone-wrapper'),
            selector = $selector.data('dropDownMenu');
    ...
    return TasksReleasesPluginTaskEdit;
