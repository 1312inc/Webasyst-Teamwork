var TasksReleasesPluginTaskTypes = ( function($) { "use strict";

    TasksReleasesPluginTaskTypes = function(options) {
        var that = this;
    ...
    TasksReleasesPluginTaskTypes.prototype.init = function () {
        var that = this;
    ...
    TasksReleasesPluginTaskTypes.prototype.highlightButton = function () {
        this.$button.removeClass('green').addClass('yellow');
    };

    TasksReleasesPluginTaskTypes.prototype.initColorPickers = function () {
        var that = this,
            $list = that.$list;
        // HERE INIT COLOR PICKER
    };

    TasksReleasesPluginTaskTypes.prototype.initAddNewTypeLink = function (editor) {
        var that = this,
    ...
    TasksReleasesPluginTaskTypes.prototype.initDeleteLinks = function () {
        var that = this,
            $list = that.$list;
        ...
        var deleteType = function ($item) {
            ...
            if (confirm('Are you sure?')) {
                $item.hide();
                var url = '?plugin=releases&module=types&action=delete';
                $.post(url, { id: id })
                    .done(function () {
                        $item.remove();
                    })
    ...
    TasksReleasesPluginTaskTypes.prototype.changeInputsListener = function () {
        var that = this,
            $form = that.$form,
    ...
    TasksReleasesPluginTaskTypes.prototype.initEditLinks = function () {
        var that = this,
            $list = that.$list,
    ...
    TasksReleasesPluginTaskTypes.prototype.initSubmit = function () {
        var that = this,
            $form = that.$form,
            $loading = $form.find('.t-loading'),
            url = "?plugin=releases&module=types&action=save";
    ...
    TasksReleasesPluginTaskTypes.prototype.initSortable = function () {
        var that = this,
            $list = that.$list;
    ...
    return TasksReleasesPluginTaskTypes;
